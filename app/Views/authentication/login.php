                ...
                <div class="card-body">
                    ...
                    <form id="formAuthentication" class="mb-3" action="<?= url_to('login') ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="email" name="email" placeholder="Enter your email or username" value="<?= old('email') ?>" autofocus required />
                        </div>
                        ...
                        <?php endif; ?>
                        <div class="mb-3">
                            <button type="submit" class="btn btn-primary d-grid w-100"><?= lang('Auth.login') ?></button>
                        </div>
                    </form>
